...
namespace cir
{
    ...
    /// <summary>
    /// This is just a bunch of math functions I've written over the years and find useful.
    /// Most of these were written back in .Net 1.0/1.1 so a few of them may be obsolete.
    /// </summary>
    public class MathUtils
    {
        ...
        /// </summary>
        private static Endian _DefaultEndian = Endian.Big;
        ...
        {
            get { return _DefaultEndian; }
            set { _DefaultEndian = value; }
        }
        ...
        { ByteArrayToNumber(ByteArray, 0, ByteArray.Length, _DefaultEndian, out ReturnValue); }
        /// <summary>
        /// Converts a byte array to a number
        /// </summary>
        /// <param name="ByteArray">Array to Convert</param>
        ...
        { ByteArrayToNumber(ByteArray, Index, Length, _DefaultEndian, out ReturnValue); }
        /// <summary>
        /// Convert a byte array to a number
        /// </summary>
        /// <param name="ByteArray">Array to Convert</param>
        ...
        { return NumberToByteArray(Number, ByteLength.Byte, _DefaultEndian); }
        /// <summary>
        /// Convert a number to a byte array
        /// </summary>
        /// <param name="Number">The number to convert</param>
        ...
        { return NumberToByteArray(Number, (int)MinimumArraySize, _DefaultEndian); }
        /// <summary>
        /// Convert a number to a byte array
        /// </summary>
        /// <param name="Number">The number to convert</param>
        ...
        { return NumberToByteArray(Number, MinimumArraySize, _DefaultEndian); }
        /// <summary>
        /// Convert a number to a byte array
        /// </summary>
        /// <param name="Number">The number to convert</param>
        ...
        { return IncrementByteArray(byteArray, _DefaultEndian); }
        /// <summary>
        /// Increment a byte array by 1
        /// </summary>
        /// <param name="byteArray">The array to increment</param>
        ...
        { return AddByteArrays(Array1, Array2, _DefaultEndian); }
        /// <summary>
        /// Adds two byte arrays (big endian)
        /// </summary>
        /// <param name="Array1">The First Array</param>
        ...
        public static byte[] AddByteArrays(byte[] Array1, byte[] Array2, Endian WhichEndian)
        {
            ...
            for (int i = 0; i < array1.Length; i++)
            {
                ...
                try
                {
                    ...
                    // Make the carry "byte" sized, get it? Bite, byte, get it?  Oh nevermind.
                    carry >>= 8;
                    carry &= 0xFF;
                }
                catch
        ...
        { return Hex(ByteArray, "", ByteLength.Byte, _DefaultEndian); }
        ...
        { return Hex(ByteArray, 0, ByteArray.Length, Separator, ByteLength.Byte, _DefaultEndian); }
        ...
        { return Hex(ByteArray, Index, Length, "", ByteLength.Byte, _DefaultEndian); }
